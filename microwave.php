...
// Build query based on filters and sorting, fixed to Microwaves category
...
$query = "SELECT * FROM products WHERE name LIKE ? AND category = 'Microwaves' AND price >= ? AND price <= ?";

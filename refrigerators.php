...
// Build query based on filters and sorting, fixed to Refrigerators category
...
$query = "SELECT * FROM products WHERE name LIKE ? AND category = 'Refrigerators' AND price >= ? AND price <= ?";
